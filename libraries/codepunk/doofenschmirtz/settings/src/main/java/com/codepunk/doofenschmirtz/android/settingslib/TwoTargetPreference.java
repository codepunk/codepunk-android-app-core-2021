 ...
 * File path: src/com/android/settingslib/TwoTargetPreference.java
 *
 * Changes to original:
 * Class is public
 * Added "android_" prefix to layout and dimension names
 */

package com.codepunk.doofenschmirtz.android.settingslib;
...
public class TwoTargetPreference extends Preference {
    ...
    private void init(Context context) {
        ...
        mSmallIconSize = context.getResources().getDimensionPixelSize(
            R.dimen.android_two_target_pref_small_icon_size);
        mMediumIconSize = context.getResources().getDimensionPixelSize(
            R.dimen.android_two_target_pref_medium_icon_size);
